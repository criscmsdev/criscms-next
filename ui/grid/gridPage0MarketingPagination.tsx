...
import { useMarketingGetPages0WithCursor } from "@/hooks/marketing/pages/pages0/useGetPagesWithCursor";
...
interface Pages0MarketingPagination {
  pages0: ListPage
}

export  function Pages0MarketingPagination({ pages0 }: Pages0MarketingPagination) {
  ...
  const { data: listPages0Food, } = useMarketingGetPages0WithCursor(myObj, query[3], pages0)
