...
import { useFindSiteFood } from '@/hooks/food/sites/usefindSite'
...
interface HeadingDashboardFood {
  site?: Site
  page?: Page
  title?: string
}
let site1: Site
export function HeadingDashboardFood({ site, page, title }: HeadingDashboardFood) {
  // console.log(site);
  ...
  if (site) {
    const { data } = useFindSiteFood(site.id, site)
    site1 = data
  }
      ...
      <div className="flex lg:items-center justify-between">
        <div className="min-w-0 flex space-x-2">
          <h2 className="text-2xl font-bold leading-7 text-gray-900 sm:truncate sm:text-3xl sm:tracking-tight">
            {/* {site ? site1?.data.seo.title : page ? page?.data.seo.title : 'Sites Food'} */}
            {title}
          </h2>
          {
            site &&
