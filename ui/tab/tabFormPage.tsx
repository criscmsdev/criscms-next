...
import { ImagePageForm, PageForm } from '../form/page'
...
export const TabFormPage:FC<TabFormPage> = ({page, type, uid, toggle, setLeft, site}) => {
    ...
    <div className="w-full max-w-lg">
      <Tab.Group>
        ...
        <Tab.Panels className="mt-2">
          ...
          >
            <PageForm toggle={toggle} setLeft={setLeft} type={type} uid={uid} page={page} site={site}/>
          </Tab.Panel>
          <Tab.Panel
            className={classNames(
              'rounded-xl bg-white'
